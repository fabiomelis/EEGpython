...
def forward_selection_auc(n_channels, dataset, tw, fs):
    ...
    utils.plot_AUC_forward(AUC_values)



def backward_selection_eer(n_channels, dataset, tw, fs):
...
def backward_selection_auc(n_channels, dataset, tw, fs):
    AUC_values = []
    channels_history = ""
