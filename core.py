...
def compute_features_exp(dataset, tw, fs, selected_channels):
...
def compute_features_exp_off_freq(dataset, tw, fs, selected_channels):
...
def compute_EER_AUC_exp (dataset, tw, fs, selected_channels):

    n_sbjs, n_channels, n_samples = dataset.shape

    ps, v_identity, n_epochs = compute_features_exp(dataset, tw, fs, selected_channels)
...
def compute_EER_AUC_exp_off (dataset, tw, fs, selected_channels):

    n_sbjs, n_channels, n_samples = dataset.shape

    ps, v_identity, n_epochs = compute_features_exp_off(dataset, tw, fs, selected_channels)
...
def compute_EER_AUC_exp_off_freq (dataset, tw, fs, selected_channels):

    n_sbjs, n_channels, n_samples = dataset.shape

    ps, v_identity, n_epochs = compute_features_exp_off_freq(dataset, tw, fs, selected_channels)
...
def compute_EER_fixed_list(list_channels, dataset, tw, fs, string):
    ...
    for current_channel in list_channels:
        ...
        if string == 'exp':
            EER, AUC = compute_EER_AUC_exp(dataset, tw, fs, analyzed_channels)
        elif string == 'off':
            EER, AUC = compute_EER_AUC_exp_off(dataset, tw, fs, analyzed_channels)
        elif string == 'freq':
            EER, AUC = compute_EER_AUC_exp_off_freq(dataset, tw, fs, analyzed_channels)
